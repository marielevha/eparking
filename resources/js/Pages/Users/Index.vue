  ...
  <div>
    ...
    <div class="flex items-center justify-between mb-6">
      <search-filter v-model="form.search" class="mr-4 w-full max-w-md" @reset="reset">
        <label class="block text-gray-700">Profile:</label>
        <select v-model="form.profile" class="form-select mt-1 w-full">
          <option :value="null" />
        ...
        <label class="block mt-4 text-gray-700">Role:</label>
    ...
    <div class="bg-white rounded-md shadow overflow-x-auto">
      <table class="w-full whitespace-nowrap">
        <tr class="text-left font-bold">
          ...
          <th class="pb-4 pt-6 px-6" colspan="1">Profile</th>
          <th class="pb-4 pt-6 px-6" colspan="1">Role</th>
        </tr>
